...
static char s_funcNames[][32] = {"fftFwd", "fftInv", "nppsMax", "nppsMin",
    ...
    "reduceMaxAbsVal256", "reduceNorm256", "reduceSum256", "zeroPad", "testTimer",
...
GpuTimes* GpuTimes::getGpuTimesObject()
{
    mxArray* prhs[1];
    prhs[0] = mxCreateDoubleScalar( 2 );
    mxArray* plhs[1];
    mexCallMATLAB(1, plhs, 1, prhs, "shear_timers");

    return *((GpuTimes**)mxGetData(plhs[0]));
}
