...
shear_double=shearing_filters_Myer([80 80 80 80],[3 3 4 4],256);

% generate shearing filters across scales j. 
shear_single=shearing_filters_Myer([80 80 80 80],[3 3 4 4],256,'single');
...
if support_GPUsingle
    ...
    try
        shear_GPUsingle=shearing_filters_Myer([80 80 80 80],[3 3 4 4],256,'GPUsingle');
    catch err
...
if support_GPUdouble
    try
        shear_GPUdouble=shearing_filters_Myer([80 80 80 80],[3 3 4 4],256,'GPUdouble');
    catch err
        support_GPUdouble = false;
    end
end
